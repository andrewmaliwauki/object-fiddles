...
MakePerson('Andrew', 'April 24', 9876);
...
function MakeCard(name, number, expiration, code) {
  var creditCard = {
    name: name,
    number: number,
...
MakeCard('Andrew Maliwauki', 4932394878769437, '0718', 983);
...
bindCard(MakePerson('Andrew', 'April 24', 9876), MakeCard('Andrew Maliwauki', 4932394878769437, '0718', 983));
